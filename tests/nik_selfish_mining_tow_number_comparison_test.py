...
plt.plot(
    alpha_values, nik_defense_1_revenue, color='r', label='Tow=6', linestyle=linestyles_dict['densely dotted'], linewidth=1.5)
plt.plot(
    alpha_values, nik_defense_2_revenue, color='b', label='Tow=12', linestyle=linestyles_dict['densely dashdotdotted'],  linewidth=1.5)
plt.plot(
    alpha_values, nik_defense_3_revenue, color='y', label='Tow=18', linestyle=linestyles_dict['densely dashed'], linewidth=1.5)
...
plt.plot(
    alpha_values, nik_defense_1_stale_block, color='r', label='Tow=6', linestyle=linestyles_dict['densely dotted'], linewidth=1.5)
plt.plot(
    alpha_values, nik_defense_2_stale_block, color='b', label='Tow=12', linestyle=linestyles_dict['densely dashdotdotted'],  linewidth=1.5)
plt.plot(
